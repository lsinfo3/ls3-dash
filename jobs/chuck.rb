...
teammembers = [['Kathrin','Borchert'],['Valentin','Burger'],['Lam','Dinh-Xuan'],['Stefan','Geissler'],['Nicholas','Gray'],['Alexej','Grigorjew'],['Matthias','Hirth'],['Stanislav','Lange'],['Frank','Loh'],['Christopher','Metter'],['Anh','Nguyen-Ngoc'],['Susanna','Schwarzmann'],['Michael','Seufert'],['Florian','Wamser'],['Thomas','Zinner'],['Anika','Schwind']]
